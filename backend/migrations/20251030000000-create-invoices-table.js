  ...
  up: async (queryInterface, Sequelize) => {
    ...
    try {
      await queryInterface.createTable('invoices', {
        ...
        shopId: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'Shops', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      ...
      console.log('Table invoices already exists (20251030 create), skipping');
    }
  },
